...
Setting::assert_value('sale', 'accounting', 'account_downpayment', '460', ['organization_id' => 1]);
Setting::assert_value('finance', 'accounting', 'fiscal_year', 2024);
Setting::assert_value('finance', 'accounting', 'accounting_entry.sequence_format', '%s{journal}/%02d{year}/%05d{sequence}', ['organization_id' => 1]);
Setting::assert_value('finance', 'accounting', 'accounting_entry.sequence', 1, ['organization_id' => 1]);
