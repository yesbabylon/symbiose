...
[$params, $providers] = eQual::announce([
    'description' => 'Backfills existing establishments with the property model.',
...
$property = "CONVERT(0x" . bin2hex('realestate\Property') . " USING utf8mb4)";

$db->sendQuery('START TRANSACTION;');

try {
    $db->sendQuery("UPDATE `{$table}` SET `model` = {$property};");
    $db->sendQuery('COMMIT;');
}
