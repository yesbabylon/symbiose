...
list($params, $providers) = announce([
    'description'   => 'Create invoices for pending receivables of given receivables queues.',
    'params'        => [
        'ids' =>  [
...
$receivablesQueues = ReceivablesQueue::ids($params['ids'])->read(['id','customer_id' => ['name'],'receivables_ids']);
