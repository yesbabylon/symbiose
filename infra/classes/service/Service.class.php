...
class Service extends Model {
    ...
    public static function getDescription() {
        return 'Infrastructure Services are designed to facilitate the management of billing, renewals, product-client associations, provider integration, documentation, and software or access management.';
    }
    ...
    public static function getColumns() {
        return [
            ...
            'service_model_id' => [
                'type'              => 'many2one',
                'foreign_object'    => 'infra\service\ServiceModel',
            ...
            'details_ids' => [
                'type'              => 'one2many',
                'foreign_object'    => 'infra\service\Detail',
