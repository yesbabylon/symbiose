...
$tests = [
    ...
    '0126' => array(
        ...
        'test'              =>  function () {
            ...
            run('do', 'lodging_payments_import' , ['data'=>'']);
            return ($booking['price']);
        },
        'assert'            =>  function ($price) {
            return $price;
    ...
    '0127' => array(
        ...
        'test'              =>  function () {
            ...
            run('do', 'lodging_booking_do-option', ['id' => $booking['id']]);
            run('do', 'lodging_booking_do-confirm', ['id' => $booking['id']]);
            // run('do', 'lodging_payments_import' , ['data'=>'']);
            return ($booking['price']);
        },
        'assert'            =>  function ($price) {
            return $price;
