...
if( !strlen($booking['customer_identity_id']['address_street']) || !strlen($booking['customer_identity_id']['address_city']) || !strlen($booking['customer_identity_id']['address_zip'])) {
    $result[] = $booking['id'];
    $links = [];
