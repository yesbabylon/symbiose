...
$booking = Booking::id($params['id'])->read(['id', 'name', 'fundings_ids'])->first();
...
if(!$is_paid) {
    ...
    $dispatch->dispatch('lodging.booking.payments', 'lodging\sale\booking\Booking', $params['id'], 'important', 'lodging_booking_check-payments', ['id' => $params['id']]);
