...
export class AppRootComponent implements OnInit {
    ...
    public async ngOnInit() {
        ...
        this.env.getEnv().then( async (environment:any) => {
            this.app_root_package = 'support';
            const data = await this.api.getMenu(this.app_root_package, 'left');
            ...
            const top_menu:any = await this.api.getMenu(this.app_root_package, 'top');
